...
// Avatar gradient palettes keyed by first char
            ...
            clients.map(c => (
              <div key={c.id} className="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex items-start gap-3 mb-3">
                  <div className={`w-11 h-11 rounded-full bg-gradient-to-br ${getGradient(c.name)} flex items-center justify-center text-white font-black text-[15px] shrink-0 shadow-sm`}>
              ...
              clients.map(c => (
                <div key={c.id} className="grid grid-cols-12 items-center px-6 py-3.5 hover:bg-slate-50/80 transition-colors group">
                  ...
                  <div className="col-span-4 flex items-center gap-3 min-w-0">
                    <div className={`w-10 h-10 rounded-full bg-gradient-to-br ${getGradient(c.name)} flex items-center justify-center text-white font-black text-[14px] shrink-0 shadow-sm group-hover:scale-105 transition-transform`}>
                      {c.name[0].toUpperCase()}
                    </div>
                    <div className="min-w-0">
